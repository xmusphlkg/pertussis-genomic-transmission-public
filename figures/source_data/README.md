...
The five `eid_figure1*.tsv` files are the panel-level inputs for the EID
public-archive timing figure: cumulative visibility, case timing,
resurgence-relative timing, milestone visibility, and the Appendix-only
project-matched comparison. Their panel assignments and transformation rules
